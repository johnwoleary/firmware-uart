...
int main(void) {
  ...
  // The Uart is configured in loopback mode with tx_empty and rx_data
  // interrupts enabled. We just have to wait for the first interrupt,
  // which will be a tx interrupt, and start sending data.

  _u8 tx_b=0xaa, rx_b=0, istatus = 0;
  int i;
